...
Config.Zones = {
	...
	RaisinFarmRouge = {
		Pos   = {x = -1836.23, y = 2209.12, z = 89.1},
		Size  = {x = 3.5, y = 3.5, z = 2.0},
		Color = {r = 136, g = 243, b = 216},
	...
	TraitementVinBlanc = {
		...
		Color = {r = 136, g = 243, b = 216},
		Name  = "Traitement du Vin Blanc",
		Type  = 1
	},

	TraitementVinRouge = {
		Pos   = {x = -55.13, y = 1914.63, z = 194.36},
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Color = {r = 136, g = 243, b = 216},
		Name  = "Traitement du Vin Rouge",
		Type  = 1
	},

	TraitementChampagne = {
		Pos   = {x = -54.81, y = 1909.43, z = 194.36},
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Color = {r = 136, g = 243, b = 216},
		Name  = "Traitement du Champagne",
		Type  = 1
	},
