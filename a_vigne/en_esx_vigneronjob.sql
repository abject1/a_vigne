...
INSERT INTO `items` (`name`, `label`, `limit`, `rare`, `can_remove`) VALUES
	('raisin_blanc', 'White grapes', 100, 0, 1),
	('raisin_rouge', 'Red grape', 100, 0, 1),
	('jus_raisin', 'grape juice', 50, 0, 1),
	('grand_cru', 'vintage bottel', 15, 0, 1),
	('vin_blanc', 'white vine', 25, 0, 1),
	('vin_rouge', 'red vine', 25, 0, 1),
	('champagne', 'Champagne', 15, 0, 1),
	('barquette_raisin', 'Tray of grapes', 60, 0, 1),
	('water', 'Water', 100, 0, 1),
	('levure', 'yeast', 100, 0, 1),
	('barquette_vide', 'empty tray', 250, 0, 1),
;
